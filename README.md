...
### 📊 1. Checklists
* 🔗 [Checklist: Progress Bar, UI, and Session Stability](./Check-lists/Check-list_Erbology_v.1.0.xlsx)

### 📝 2. Test Cases
* 🔗 [Test Cases: Shopping Cart Thresholds and Authentication Forms](./Test-cases/Test-case_Erbology_v.1.0.xlsx)

### 🐛 3. Bug Reports
* 🔗 [Bug Reports: Critical and Minor Defects](./Bug-raports/Bug-raport_Erbology_v.1.0.xlsx)
...
* Linux Bash
* Windows PowerShell
* Remote Access and Log Analysis
